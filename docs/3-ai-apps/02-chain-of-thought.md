...
> 💻 完整可运行代码：[code-examples/03-ai-apps/prompt_engineering/02_chain_of_thought.py](https://github.com/skyhe58/guide-ai/tree/main/code-examples/03-ai-apps/prompt_engineering/02_chain_of_thought.py)
> 🐍 Python 版本：3.11+
> 📦 依赖：ollama（可选，服务模式）
