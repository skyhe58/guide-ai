...
> 💻 完整可运行代码：[code-examples/03-ai-apps/agent/01_function_calling.py](https://github.com/skyhe58/guide-ai/tree/main/code-examples/03-ai-apps/agent/01_function_calling.py)
> 🐍 Python 版本：3.11+
> 📦 依赖：标准库（默认模式）
