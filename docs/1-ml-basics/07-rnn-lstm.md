...
> 💻 完整可运行代码：[code-examples/01-ml-basics/deep_learning/03_rnn_lstm.py](https://github.com/skyhe58/guide-ai/tree/main/code-examples/01-ml-basics/deep_learning/03_rnn_lstm.py)
> 🐍 Python 版本：3.11+
> 📦 依赖：torch>=2.1
