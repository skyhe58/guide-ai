...
> ⚠️ **本模块为所有后续模块的必修前置条件。** 无论选择 4 个月速成路线还是 6-8 个月全栈路线，都必须先完成本模块。

## 模块概述

本模块帮助后端开发者快速补齐 Python 生产级编程和数据工具基础，为后续 AI 学习打下坚实基础。预计学习时间：**1 周**。
...
| 序号 | 知识点 | 难度 | 面试频率 | 代码示例 |
|:----:|--------|:----:|:--------:|:--------:|
| 07 | [Git/GitHub](/0-prerequisites/07-git-github) | ⭐ | 🔥 | — |
| 08 | [Jupyter Notebook](/0-prerequisites/08-jupyter-notebook) | ⭐ | 🔥 | — |
| 09 | [虚拟环境管理](/0-prerequisites/09-virtual-env) | ⭐ | 🔥 | — |
...
- 📋 [面试指南](/0-prerequisites/interview) — Python 异步、类型注解、NumPy 向量化等高频题
- 📝 [速查卡片](/0-prerequisites/cheatsheet) — 核心概念和常用 API 速查

## 下一步

完成本模块后，进入 → [模块 1：AI/ML 基础理论](/1-ml-basics/)
